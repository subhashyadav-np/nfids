@extends('layouts.backend', [$title = "Edit Blog"])
        ...
        <div class="col-12">
            <form method="POST" action="{{route('blog.update', $Blog->id)}}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="title" value="{{$Blog->title}}" class="form-control" id="blogTitle" placeholder="Enter blog title here" required>
                </div>
                <div class="form-group">
                    <label for="blogCover">Blog Thubmnail *</label>
                    <input type="file" name="cover" class="form-control-file" id="blogCover" aria-describedby="blog_cover_help">
                ...
                <div class="form-group">
                    ...
                    <textarea name="blog" id="blogPost" cols="30" rows="10" class="form-control" required>{{$Blog->blog}}</textarea>
                </div>
                <div class="form-group">
                    <label for="blogMetaDesc">Write Blog Meta Description</label>
                    <textarea name="meta_desc" id="blogMetaDesc" cols="30" rows="4" class="form-control" aria-describedby="meta_desc_info">{{$Blog->meta_desc}}</textarea>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="keywords" value="{{$Blog->keywords}}" class="form-control" id="blogMetaKeys" aria-describedby="meta_key_info"
